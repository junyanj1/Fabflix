...
public class ShoppingCartUpdateResponseModel extends Model {
    private int resultCode;
    private String message;

    public ShoppingCartUpdateResponseModel(@JsonProperty(value = "resultCode", required = true) int resultCode) {
    ...
    public String toString() {
        return "ShoppingCartUpdateResponseModel{" +
