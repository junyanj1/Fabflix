...
public class ShoppingCartDeleteResponseModel extends Model {
    private int resultCode;
    private String message;

    public ShoppingCartDeleteResponseModel(@JsonProperty(value = "resultCode", required = true) int resultCode) {
    ...
    public String toString() {
        return "ShoppingCartDeleteResponseModel{" +
