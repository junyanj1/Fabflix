...
public class CreditCardInfoResponseModel extends Model {
    private int resultCode;
    private String message;

    public CreditCardInfoResponseModel(@JsonProperty(value = "resultCode", required = true) int resultCode) {
    ...
    public String toString() {
        return "CreditCardInfoResponseModel{" +
