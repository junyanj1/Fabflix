...
public class ShoppingCartRetrieveResponseModel extends Model {
    private int resultCode;
    private String message;

    public ShoppingCartRetrieveResponseModel(@JsonProperty(value = "resultCode", required = true) int resultCode) {
    ...
    public String toString() {
        return "ShoppingCartRetrieveResponseModel{" +
