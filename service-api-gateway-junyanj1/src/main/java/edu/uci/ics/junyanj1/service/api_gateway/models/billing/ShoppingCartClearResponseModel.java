...
public class ShoppingCartClearResponseModel extends Model {
    private int resultCode;
    private String message;

    public ShoppingCartClearResponseModel(@JsonProperty(value = "resultCode", required = true) int resultCode) {
    ...
    public String toString() {
        return "ShoppingCartClearResponseModel{" +
