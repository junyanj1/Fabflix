...
public class AddStarResponseModel extends Model {
    private int resultCode;
    private String message;

    @JsonCreator
    public AddStarResponseModel(@JsonProperty(value = "resultCode", required = true) int resultCode) {
