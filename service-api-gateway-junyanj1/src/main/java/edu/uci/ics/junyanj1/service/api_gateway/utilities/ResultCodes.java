...
public class ResultCodes {
    ...
    public static final int NO_EMAIL = -16;
    public static final int NO_SESSION_ID = -17;
    public static final int NO_TRANSACTION_ID = -18;
    ...
    public static final int[] resultCodes = {
            ...
            CANNOT_ELEVATE_USER_TO_ROOT,NO_SESSION_ID,NO_TRANSACTION_ID,NO_EMAIL
    };
    ...
    public static String setMessage(int code) {
        switch (code) {
            ...
            case NO_TRANSACTION_ID:
                return "TransactionID not provided in request header.";
