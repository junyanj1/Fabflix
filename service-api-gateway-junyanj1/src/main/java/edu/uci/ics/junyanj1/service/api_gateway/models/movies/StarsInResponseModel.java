...
public class StarsInResponseModel extends Model {
    private int resultCode;
    private String message;

    public StarsInResponseModel(@JsonProperty(value = "resultCode", required = true) int resultCode) {
