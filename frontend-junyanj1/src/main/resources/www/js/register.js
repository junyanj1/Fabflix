function getRegisterReport(transactionid,delay) {
    let st = "nocontent";
    let resp = null;
    let timerid = 0;
        ...
        $.ajax({
            ...
            complete: function (res,status,xhr) {
                ...
                if (status !== "nocontent") {
                    ...
                    if (status === "success" && res.responseJSON.resultCode==110) {
...
$("form").submit(function (event) {
        ...
        $.ajax({
            ...
            dataType:"json",
            url: "http://128.195.6.93:5179/api/g/idm/register",
            ...
            success: function (res,status,xhr) {
                ...
                debugger;
                getRegisterReport(transactionid,delay)
            },
