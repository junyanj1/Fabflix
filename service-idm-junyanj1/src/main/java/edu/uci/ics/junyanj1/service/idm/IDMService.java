package edu.uci.ics.junyanj1.service.idm;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.junyanj1.service.idm.configs.Configs;
...
public class IDMService {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.junyanj1.service.idm.resources");
