package edu.uci.ics.junyanj1.service.idm.configs;

import edu.uci.ics.junyanj1.service.idm.logger.ServiceLogger;
import edu.uci.ics.junyanj1.service.idm.models.ConfigsModel;
...
public class Configs {
    ...
    private final long DEFAULT_TIMEOUT = 600000; // 10 min
    private final long DEFAULT_EXPIRATION = 1800000; // 30 min
    ...
    public Configs(ConfigsModel cm) throws NullPointerException {
        if (cm == null) {
            ...
            if (timeout == 0) {
                timeout = DEFAULT_TIMEOUT;
                System.err.println("No timeout value found in configuration file. ");
            } else {
            ...
            if (expiration == 0) {
                expiration = DEFAULT_EXPIRATION;
                System.err.println("No expiration time found in configuration file. ");
            } else {
