...
public class MovieConfigs {
    ...
    public String getIdmScheme() {
        return idmConfigs.getScheme();
    }

    public String getIdmHostName() {
        return idmConfigs.getHostName();
    }

    public int getIdmPort() {
        return idmConfigs.getPort();
    }

    public String getIdmPath() {
        return idmConfigs.getPath();
    }

    public String getIdmPrivilege() {
        return idmConfigs.getPrivilege();
    }

    public String getIdmUri() {
        return idmConfigs.getScheme() + idmConfigs.getHostName() + ":" + idmConfigs.getPort() + idmConfigs.getPath();
    }
}
